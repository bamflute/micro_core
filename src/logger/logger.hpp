        ...
        public:
            ...
            static int32_t init()
            {
                ...
                try
                {
                    ...
                    (
                        //attribute
                        //boost::log::keywords::file_name = (matrix::core::path_util::get_exe_dir() /= "logs/%Y%m%d%H%M%S_%N.log").c_str(),
                        //boost::log::keywords::target = (matrix::core::path_util::get_exe_dir() /= "logs"),
