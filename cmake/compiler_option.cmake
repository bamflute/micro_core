...
if(APPLE)
    set(CXX_FLAGS "-std=c++14 -Wno-inconsistent-missing-override -Wno-expansion-to-defined")
...
if ((DEBUG_MODE) OR (CMAKE_BUILD_TYPE STREQUAL "Debug"))
    set(CXX_FLAGS "${CXX_FLAGS} -O0 -Wall -g -ggdb -pthread -static-libstdc++")
    set(CXX_PREPROCESS_FLAGS "${CXX_PREPROCESS_FLAGS} -DDEBUG -D_REENTRANT -pthread")
else ()
    set(CXX_FLAGS "${CXX_FLAGS} -O3 -Wall -pthread -static-libstdc++")
    set(CXX_PREPROCESS_FLAGS "${CXX_PREPROCESS_FLAGS} -DNDEBUG -pthread")
endif ()


# dcloud 3rd library path
if (APPLE)
    set(MICRO_CORE_3RD_LIB_ROOT_PATH ${CMAKE_SOURCE_DIR}/lib/macosx)
endif ()

if (LINUX)
    set(MICRO_CORE_3RD_LIB_ROOT_PATH ${CMAKE_SOURCE_DIR}//lib/linux)
endif ()
